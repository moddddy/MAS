            ...
            [
                [
                    InlineKeyboardButton(
                        "• نـصـب بـوتك مـن هـنا •", url="https://t.me/S_T_Dl",
                    )
                ],
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/b2c4ce7e2d6f302169df5.jpg",
        caption=f""""اهلا وسهلا بك في سورس ماس العربي مميزات السورس قويه وفريده يمكنك امتلاك بوت كامل حقوقك قوم بمراسلة مطور السورس"",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("قناة السورس الرسمية", url=f"https://t.me/S_T_Dl"),
            ],
            [
                InlineKeyboardButton(
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("مطور السورس", url=f"https://t.me/QQWGT"),
            ],
            [
                InlineKeyboardButton(
